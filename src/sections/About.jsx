    ...
    <section className="c-space section-spacing">
      ...
      >
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, Im Ricardo Camargo</p>
            <p className="subtext">
              Throughout my journey as a Systems Analysis and Development
              student, I've mastered frontend and backend technologies to create
              innovative web solutions and interactive applications.
            </p>
          </div>
